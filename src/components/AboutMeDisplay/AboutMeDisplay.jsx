...
export default function AboutMeDisplay(props) {
  ...
  return (
    ...
    >
        <Slide direction="right" appear={true} mountOnEnter unmountOnExit in={props.bioShow} timeout={{ enter: 1000, exit: 1000}}>
          <Box>
            <BioDisplay elevation={props.elevation}/>
          </Box>
        </Slide>
        <Slide direction="right" appear={true} mountOnEnter unmountOnExit in={props.technologyShow} timeout={{ enter: 1000, exit: 1000}}>
        <Box >
          <SkillsDisplay elevation={props.elevation}/>
        </Box>
        </Slide>
        <Slide direction="right" appear={true} mountOnEnter unmountOnExit in={props.educationShow} timeout={{ enter: 1000, exit: 1000}}>
        <Box >
